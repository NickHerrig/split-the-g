...
export function PlacesAutocomplete({ onSelect, initialValue = '', className = '' }: PlacesAutocompleteProps) {
        ...
        <div className="absolute z-10 w-full mt-1 bg-guinness-black border border-guinness-gold/20 rounded-lg max-h-60 overflow-auto">
          {suggestions.map((place, index) => (
            ...
            >
              ...
              <div className="text-sm text-guinness-tan/60">{place.address}</div>
            </button>
          ))}
          <button
