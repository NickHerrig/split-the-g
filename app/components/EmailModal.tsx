...
export function EmailModal({ scoreId, onClose, isOpen }: EmailModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-guinness-black/90 flex items-center justify-center p-4 z-50">
      <div className="bg-guinness-cream text-guinness-black p-8 rounded-lg max-w-md w-full relative border-2 border-guinness-gold">
        {/* Decorative elements */}
