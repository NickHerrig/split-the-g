...
export default function Home() {
  ...
  // Move form state outside of processing modal
  ...
  return (
    <main className="flex items-center justify-center min-h-screen bg-guinness-black text-guinness-cream">
      ...
      <a
        href="/faq"
        className="fixed top-4 left-4 z-40 p-1.5 bg-guinness-gold/10 hover:bg-guinness-gold/20 text-guinness-gold border border-guinness-gold/20 rounded-lg transition-colors flex items-center gap-1.5"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-5 w-5"
